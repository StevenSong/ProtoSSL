...
ds_train = DatasetCls(dataset_path=dataset_path, split="train", sampling_rate=16000)
ds_val = DatasetCls(dataset_path=dataset_path, split="val", sampling_rate=16000)
ds_test = DatasetCls(dataset_path=dataset_path, split="test", sampling_rate=16000)
