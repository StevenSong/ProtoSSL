# Adapted from ECGFounder/net1d.py, essentially ResNet1D but with some custom modifications
# "An Electrocardiogram Foundation Model Built on over 10 Million Recordings" (Li et al. 2025)
...
class Net1D(BaseEncoder):
    def __init__(
        ...
        self.emb_dim = out_channels  # type: ignore
