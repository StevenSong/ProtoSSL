...
class PrototypeEncoder(BaseEncoder):
    def __init__(
        ...
        *,  # enforce kwargs
        ...
        self.prototypes = nn.Parameter(
            torch.randn(n_prototypes, self.backbone.emb_dim),
            requires_grad=True,
        )
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if self.prototype_type == "partial":
            ...
            x = self.sim_fn(x_backbone, self.prototypes)  # (B*num_chunks, P)
