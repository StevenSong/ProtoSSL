...
if os.environ.get("USE_HEEDB_150", False):
    print("====================defines.py=====================")
    print("USING HEEDB 150 LABEL SET")
    print("===================================================")
    HEEDB_TARGETS = {
        "ABNORMAL ECG": [1699],
        "NORMAL SINUS RHYTHM": [22],
        ...
        "NON-SPECIFIC CHANGE IN ST SEGMENT IN": [1116, 1117],
        ...
        "WIDE QRS RHYTHM": [237],
        "WITH PREMATURE VENTRICULAR OR ABERRANTLY CONDUCTED COMPLEXES": [173, 181],
        ...
        "ACUTE MI / STEMI": [821],
        "INFERIOR-POSTERIOR INFARCT": [801],
