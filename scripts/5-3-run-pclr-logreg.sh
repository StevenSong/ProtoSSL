...
EXP_NAME="pclr-logreg"
PRETRAIN_RUN=$(realpath -m $RUN_DIR/../../pclr-heedb)

python ecg-fms/_compute_pclr_embeddings.py \
--dataset-path $DATASET_PATH \
--ckpt $PRETRAIN_RUN/train-contraster/latest/best.ckpt \
