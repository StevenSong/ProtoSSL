...
EXP_DIR=$RUN_DIR/protoecgnet-echonext-fusion
...
python tune.py \
    ...
    --fusion_weights1 $RUN_DIR/protoecgnet-echonext-cat1/checkpoints/proj_cat1/proj_cat1_projection.pth \
    --fusion_weights3 $RUN_DIR/protoecgnet-echonext-cat3/checkpoints/proj_cat3/proj_cat3_projection.pth \
    --fusion_weights4 $RUN_DIR/protoecgnet-echonext-cat4/checkpoints/proj_cat4/proj_cat4_projection.pth \
