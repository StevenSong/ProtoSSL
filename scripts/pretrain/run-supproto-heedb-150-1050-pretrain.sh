...
#SBATCH --time=0
#SBATCH --output /home/songs1/slurm-logs/supproto-heedb-150-1050-%j.out
...
EXP_NAME="supproto-heedb-150-1050"
BACKBONE=resnet18
CONV=2D
...
python -m protossl.trainer \
    ...
    --config $REPO_ROOT/configs/pretrain-supervised-heedb-150-1050.yaml \
